<?php
	...
	$pdf->AddPage('L','A4',0);
	$pdf->SetFont('THB','',24);
	$pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','อ.ส.๐๑.๖'),0,1,"R");
	$pdf->Ln();
	$pdf->Cell(0,15,iconv( 'UTF-8','TIS-620','รายงานขออนุญาตจ่ายแสตมป์อากร'),0,1,"C");
	$pdf->SetFont('TH','',16);
	...
	$pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','คณะกรรมการฯ ได้พิจารณาแล้วเห็นควรจ่ายแสตมป์อากรให้แก่ผู้ขอเบิกตามรายละเอียดต่อไปนี้'),0,1,"L");
	$pdf->Cell(0,8,iconv( 'UTF-8','TIS-620',''),0,1,"L");
	...
	$pdf->Cell(15,6,'',0,0,'L');
	$pdf->Cell(160,6,iconv( 'UTF-8','TIS-620','จึงเรียนมาเพื่อโปรดพิจารณาอนุญาต'),0,0,'L');
	$pdf->Cell(85,6,iconv( 'UTF-8','TIS-620',$pdf->Image("../Imgs/Checkbox-icon-un.png", 201, $pdf->GetY()+2,-200).'         อนุญาตให้จ่ายได้'),0,0,'L');
	$pdf->Cell(0,6,'',0,1);
	
	$pdf->Cell(15,6,'',0,0,'L');
	$pdf->Cell(160,6,'',0,0,'L');
	$pdf->Cell(85,6,iconv( 'UTF-8','TIS-620',$pdf->Image("../Imgs/Checkbox-icon-un.png", 201, $pdf->GetY()+2,-200).'         ไม่อนุญาต ระบุเหตุผล......................................'),0,0,'L');
	$pdf->Cell(0,6,'',0,1);
	...
	$pdf->Cell(55,6,iconv( 'UTF-8','TIS-620','ตัวอย่างลายมือชื่อ'),0,0,'C');
	$pdf->Cell(4,6,'',0,0);
	$pdf->SetFont('TH','',16);
