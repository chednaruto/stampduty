...
$docx = new DOCXTemplate('FPTTemplate.docx');
...
t.allowed_withdraw_one_bath,t.allowed_withdraw_five_bath,t.allowed_withdraw_twenty_bath,t.pay_signature_id,
...
twt.withdraw_id1,twt.withdraw_id2,twt.withdraw_id3,t.pay_document_date,twt.withdraw_transaction_date,t.pay_document_number
...
LEFT JOIN tb_office t1 ON twt.officeid = t1.office_code
...
if($row_al['pay_document_date']=="" || $row_al['pay_document_date'] == "0000-00-00"){
	$docx->set('ALLOWEDDATE',EngToThaiNumber("............เดือน...........................พ.ศ................"));
}else{
	$docx->set('ALLOWEDDATE',EngToThaiNumber(thai_date($row_al['pay_document_date'])));
}
if($row_al['pay_document_number'] == "" ){
	$docx->set('ALLOWEDNUMBER',EngToThaiNumber("....................................................."));
}else{
	$docx->set('ALLOWEDNUMBER',EngToThaiNumber($row_al['pay_document_number']));
}
...
//USE BEFO
$dataU = $exportClass->GetUsage($row_al['withdraw_officeid'],$row_al['withdraw_transaction_date']);
...
$dataB = $exportClass->GetBalanceDate($row_al['withdraw_officeid'],$row_al['withdraw_transaction_date']);
...
$allowed_withdraw_transaction_id="FPT".substr($allowed_withdraw_transaction_id,4,20);
