<?php
	...
	$docx = new DOCXTemplate('FSPTemplate.docx');
	...
	$date1 = strtotime($row1['stamp_party_accep_date']);
	...
	$docx->set("FULLLNAMESI",EngToThaiNumber($rowsn['fullname']));
	$docx->saveAs("Doc/".$stamp_party_transaction_id.".docx");
	...
	header( "location: Doc/".$stamp_party_transaction_id.".docx");
