				...
				<div class="col-xs-12">
					...
					<div>
						<div id="user-profile-1" class="user-profile row">
							...
							<?php
								$sql1 = "SELECT * FROM tb_signature_board t WHERE t.id ='".$_GET[id]."' AND t.officeid = '".$_SESSION['OFFICEID']."'";
								...
								<div class="profile-user-info profile-user-info-striped">
                                            ...
                                            <div class="profile-info-value col-sm-8" style="height:40px;">
                                                <span>
                                                    <div class="input-group col-sm-12">
                                                        <input class="form-control center input-sm" type="text" id="uid_tf" onkeydown="clearData()" value="<?php echo $row1['id']; ?>" readonly="readonly">
                                                    </div>
                                                </span>
                                            </div>
                                    ...
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span id="fullname_tf"><?php echo $row1['fullname']; ?></span>
										</div>
									</div>
                                    <div class="profile-info-row">
										<div class="profile-info-name"> ตำแหน่ง </div>
										<div class="profile-info-value col-sm-12">
											<span id="position_m_tf"><?php echo $row1['position_m']; ?></span>
										</div>
									</div>
                                    <div class="profile-info-row">
										<div class="profile-info-name"> ตำแหน่งแสดงในเอกสาร </div>
										<div class="profile-info-value col-sm-12">
											<span><input class="form-control left input-sm" type="text" id="position_display_tf" value="<?php echo $row1['position_display']; ?>"></span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="col-xs-12 center">
                                                    <label>
                                                        <input id="status_tf" class="ace ace-switch ace-switch-6" type="checkbox" <?php if($row1['status']=='Y') echo 'checked="checked"'; ?> >
