            ...
            <div class="row">
				<div class="col-xs-12">
						...
						<div id="user-profile-1" class="user-profile row">
                            ...
                            <div class="col-xs-12 col-sm-9">
								...
								<div class="social-or-login center">
                                    <span class="bigger-110"> ข้อมูลคำสั่งแต่งตั้งคณะกรรมการคลังแสตมป์อากร </span>
                                </div>
                                <div class="space-12"></div>
								...
								<div class="profile-user-info profile-user-info-striped">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
                                                    <input class="form-control center" type="text" id="stock_document_number_tf" >
												</div>                                                
                                            </span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
													<input class="form-control date-picker center" id="stock_document_date_tf" type="text" data-date-format="dd-mm-yyyy" />
                            ...
                            <div class="col-xs-12 col-sm-9">
								<div class="space-12"></div>
								<div class="social-or-login center">
                                    <span class="bigger-110"> ยกเลิกคำสั่งแต่งตั้งคณะกรรมการคลังแสตมป์อากร (เดิม)</span>
                                </div>
                                <div class="space-12"></div>
								<!-- #section:pages/profile.info -->
								<div class="profile-user-info profile-user-info-striped">
									<div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
                                                    <input class="form-control center" type="text" id="stock_document_old_number_tf" >
												</div>                                                
                                            </span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
													<input class="form-control date-picker center" id="stock_document_old_date_tf" type="text" data-date-format="dd-mm-yyyy" />
													<span class="input-group-addon">
														<i class="fa fa-calendar bigger-110"></i>
													</span>
												</div>                                               
                            ...
                            <div class="col-xs-12 col-sm-12">
                            	<div class="space-12"></div>
                                <div class="social-or-login center">
                                    <span class="bigger-110"> ข้อมูลคณะกรรมการคลังแสตมป์อากร </span>
                                </div>
                                <div class="space-12"></div>
                                <div id="list"> 
                                            ...
                                            <div class="profile-info-value " style="width:200px;vertical-align:middle;">
                                                <span>
                                                	<div class="input-group" style="width:100%;">
                                                        <div>
															<select class="form-control" id="stock_board_type_id1_tf" style="width:100%;">
																<option value="">  </option>
																<option value="1">ประธาน</option>
																<option value="2">กรรมการ</option>
                                                                <option value="3">ปฏิบัติหน้าที่แทน</option>
															</select>
														</div>
                                                    </div>
                                                </span>
                    ...
                    <div class="clearfix">
                   		<div class="alert alert-block alert-success" style="text-align:center;">
                            <div class="center">
								<button type="button" class="btn btn-sm btn-primary btn-white btn-round" onclick="saveStockBoard()">
...
<script type="text/javascript">
	...
	function saveStockBoard(){
		...
		var dfrom = $("#stock_document_old_date_tf").val().split("-")
