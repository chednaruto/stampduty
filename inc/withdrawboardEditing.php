				...
				<div class="col-xs-12">
					...
					<div>
						<div id="user-profile-1" class="user-profile row">
							...
							<?php
								$sql1 = "SELECT * FROM tb_withdraw_document t WHERE t.withdraw_document_id='".$_GET['withdraw_document_id']."'";
								$rs1 = mysql_query($sql1,$connection);
								$row1 = mysql_fetch_assoc($rs1);
								if($row1['withdraw_document_date']=="0000-00-00"){
									$row1['withdraw_document_date'] = "";
								}
								if($row1['withdraw_document_old_date']=="0000-00-00"){
                            ...
                            <div class="col-xs-12 col-sm-9">
								...
								<div class="social-or-login center">
                                    <span class="bigger-110"> ข้อมูลคำสั่งแต่งตั้งคณะกรรมการเบิกแสตมป์อากร </span>
                                </div>
                                <div class="space-12"></div>
								...
								<div class="profile-user-info profile-user-info-striped">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
                                                    <input class="form-control center" type="text" id="withdraw_document_number_tf" value="<?php echo $row1['withdraw_document_number']; ?>">
												</div>                                                
                                            </span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
													<input class="form-control date-picker center" id="withdraw_document_date_tf" type="text" data-date-format="dd-mm-yyyy" value="<?php if($row1['withdraw_document_date']!="0000-00-00" && $row1['withdraw_document_date'] != ""){echo date('d-m-Y',strtotime($row1['withdraw_document_date']));} ?>"/>
                            ...
                            <div class="col-xs-12 col-sm-9">
								<div class="space-12"></div>
								<div class="social-or-login center">
                                    <span class="bigger-110"> ยกเลิกคำสั่งแต่งตั้งคณะกรรมการเบิกแสตมป์อากร (เดิม)</span>
                                </div>
                                <div class="space-12"></div>
								<!-- #section:pages/profile.info -->
								<div class="profile-user-info profile-user-info-striped">
									<div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
                                                    <input class="form-control center" type="text" id="withdraw_document_old_number_tf" value="<?php echo $row1['withdraw_document_old_number']; ?>"/>
												</div>                                                
                                            </span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
													<input class="form-control date-picker center" id="withdraw_document_old_date_tf" type="text" data-date-format="dd-mm-yyyy" value="<?php if($row1['withdraw_document_old_date']!="0000-00-00" && $row1['withdraw_document_old_date'] != ""){ echo date('d-m-Y',strtotime($row1['withdraw_document_old_date']));} ?>"/>
													<span class="input-group-addon">
														<i class="fa fa-calendar bigger-110"></i>
													</span>
												</div>                                               
                            ...
                            <div class="col-xs-12 col-sm-12">
                            	<div class="space-12"></div>
                                <div class="social-or-login center">
                                    <span class="bigger-110"> ข้อมูลคณะกรรมการเบิกแสตมป์อากร </span>
                                </div>
                                <div class="space-12"></div>
                                <div id="list">
                                	<?php
										$sql2 = "SELECT * FROM tb_withdraw_board t WHERE t.withdraw_document_id = '".$_GET['withdraw_document_id']."'";
                                            ...
                                            <div class="profile-info-value " style="width:200px;vertical-align:middle;">
                                                <span>
                                                	<div class="input-group" style="width:100%;">
                                                        <div>
															<select class="form-control" id="withdraw_board_type_id<?php echo $i; ?>_tf" style="width:100%;">
																<option value="">  </option>
																<option value="1" <?php if($row2['withdraw_board_type_id']==1){ echo 'selected="selected"';} ?> >คณะกรรมการเบิก</option>
																<option value="2" <?php if($row2['withdraw_board_type_id']==2){ echo 'selected="selected"';} ?> >ปฏิบัติหน้าที่แทน</option>
															</select>
														</div>
                                                    </div>
                                                </span>
...
<script type="text/javascript">
	...
	function saveMandate(){
		...
		var withdraw_document_id ='<?php echo $_GET['withdraw_document_id']; ?>';
		...
		var data = {
			"withdraw_document_id":withdraw_document_id,
