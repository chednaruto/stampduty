	...
	<div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
					<a href="index.php?service=withdrawtransactionManager"> รายการคำขอเบิกแสตมป์อากร (อ.ส.01) </a>
				</li>
				<li> แก้ไขคำขอเบิกแสตมป์อากร (อ.ส.01) </li>
            </ul>
        ...
        <div class="page-content">
            <div class="page-header">
                <h1> แก้ไขคำขอเบิกแสตมป์อากร (อ.ส.01) </h1>
            </div>
				...
				<div class="col-xs-12">
					...
					<div>
						<div id="user-profile-1" class="user-profile row">
							...
							<?php
								$sql_wt = "SELECT * FROM tb_withdraw_transaction t WHERE t.withdraw_transaction_id = '".$_GET['withdraw_transaction_id']."'";
								...
								<div class="profile-user-info profile-user-info-striped">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
                                                    <input class="form-control center" type="text" id="withdraw_document_id_tf" value="<?php echo $row_wt['withdraw_document_id']; ?>">
												</div>                                                
                                            </span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
													<input class="form-control date-picker center" id="withdraw_document_date_tf" type="text" data-date-format="dd-mm-yyyy" value="<?php echo $row_wt['withdraw_document_date']=="0000-00-00" ? "":date('d-m-Y',strtotime($row_wt['withdraw_document_date'])); ?>"/>
								...
								<div class="profile-user-info profile-user-info-striped">
									<div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-12">
                                                    <input class="form-control center" type="text" id="amount_withdraw_one_bath_tf" style="width:100%;" onchange="CallMoney(this.value,1,'one')" value="<?php echo $row_wt['amount_withdraw_one_bath']; ?>">
												</div>                                                
                                            </span>
										</div>
                                        ...
                                        <div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-12">
                                                	<input class="form-control center" type="text" id="money_one_bath_tf" style="width:100%;" readonly="readonly" value="<?php echo $row_wt['amount_withdraw_one_bath']; ?>">
                                                </div>
                                           	</span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-12">
                                                    <input class="form-control center" type="text" id="amount_withdraw_five_bath_tf" style="width:100%;" onchange="CallMoney(this.value,5,'five')" value="<?php echo $row_wt['amount_withdraw_five_bath']; ?>">
												</div>                                                
                                            </span>
										</div>
                                        <div class="profile-info-name" style="width:100px;">จำนวนเงิน</div>
                                        <div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-12">
                                                	<input class="form-control center" type="text" id="money_five_bath_tf" style="width:100%;" readonly="readonly" value="<?php echo $row_wt['amount_withdraw_five_bath']*5; ?>">
                                                </div>
                                           	</span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-12">
                                                    <input class="form-control center" type="text" id="amount_withdraw_twenty_bath_tf" style="width:100%;" onchange="CallMoney(this.value,20,'twenty')" value="<?php echo $row_wt['amount_withdraw_twenty_bath']; ?>">
												</div>                                                
                                            </span>
										</div>
                                        <div class="profile-info-name" style="width:100px;">จำนวนเงิน</div>
                                        <div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-12">
                                                	<input class="form-control center" type="text" id="money_twenty_bath_tf" style="width:100%;" readonly="readonly" value="<?php echo $row_wt['amount_withdraw_twenty_bath']*20; ?>">
                                                </div>
                                           	</span>
										</div>
									</div>
                                ...
                                <div id="list"> 
                                    <div class="profile-user-info profile-user-info-striped profile1">
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value" style="width:300px;height:40px;">
                                                    ...
                                                    <div class="input-group  col-sm-12">
                                                    	...
                                                    	<?php
															...
															while($row_wb = mysql_fetch_array($rs_wb)){
																if($row_wt['withdraw_id1']==$row_wb['id']){
																	echo '<option value="'.$row_wb['id'].'" selected="selected">'.$row_wb['fullname'].' ['.$row_wb['withdraw_board_type_name'].']</option>';
																}else{
                                           	...
                                           	<?php
												$sql_2 = "SELECT * ,tbt.withdraw_board_type_name
															FROM (
																SELECT * 
																FROM tb_withdraw_document t 
																WHERE t.withdraw_document_status = 'Y' AND t.officeid = '".$_SESSION['OFFICEID']."'
												...
												$rs_2 = mysql_query($sql_2,$connection);
												$row_2 = mysql_fetch_assoc($rs_2);
											?>
                                            ...
                                            <div class="profile-info-value " style="width:300px;vertical-align:middle;">
                                                <span id="position_m1_tf"><?php echo $row_2['position_m']; ?></span>
                                            </div>
                                            ...
                                            <div class="profile-info-value " style="width:200px;vertical-align:middle;">
                                                <span id="sinature_img1_tf"><img src="http://eoffice.rd.go.th/e_office/signature/<?php echo $row_wt['withdraw_id1']; ?>.jpg" style="height:32px;"/></span>
                                            </div>
                                    ...
                                    <div class="profile-user-info profile-user-info-striped profile2">
                                        <div class="profile-info-row">
                                                ...
                                                <span>
                                                    <div class="input-group  col-sm-12">
                                                    	...
                                                    	<?php
															...
															$rs_wb = mysql_query($sql_wb,$connection);
															while($row_wb = mysql_fetch_array($rs_wb)){
																if($row_wt['withdraw_id2']==$row_wb['id']){
																	echo '<option value="'.$row_wb['id'].'" selected="selected">'.$row_wb['fullname'].' ['.$row_wb['withdraw_board_type_name'].']</option>';
																}else{
																	echo '<option value="'.$row_wb['id'].'">'.$row_wb['fullname'].' ['.$row_wb['withdraw_board_type_name'].']</option>';
																}
                                            ...
                                            <div class="profile-info-name" style="width:100px;"> ตำแหน่ง </div>
                                            <div class="profile-info-value " style="width:300px;vertical-align:middle;">
                                                <span id="position_m2_tf"><?php echo $row_2['position_m']; ?></span>
                                            </div>
                                            <div class="profile-info-name" style="width:100px;"> ตัวอย่างลายมือชื่อ </div>
                                            <div class="profile-info-value " style="width:200px;vertical-align:middle;">
                                                <span id="sinature_img2_tf"><img src="http://eoffice.rd.go.th/e_office/signature/<?php echo $row_wt['withdraw_id2']; ?>.jpg" style="height:32px;"/></span>
                                            </div>
                                    ...
                                    <div class="profile-user-info profile-user-info-striped profile3">
                                        <div class="profile-info-row">
                                                ...
                                                <span>
                                                    <div class="input-group  col-sm-12">
                                                    	...
                                                    	<?php
															...
															$rs_wb = mysql_query($sql_wb,$connection);
															while($row_wb = mysql_fetch_array($rs_wb)){
																if($row_wt['withdraw_id3']==$row_wb['id']){
																	echo '<option value="'.$row_wb['id'].'" selected="selected">'.$row_wb['fullname'].' ['.$row_wb['withdraw_board_type_name'].']</option>';
																}else{
																	echo '<option value="'.$row_wb['id'].'">'.$row_wb['fullname'].' ['.$row_wb['withdraw_board_type_name'].']</option>';
																}
                                            ...
                                            <div class="profile-info-name" style="width:100px;"> ตำแหน่ง </div>
                                            <div class="profile-info-value " style="width:300px;vertical-align:middle;">
                                                <span id="position_m3_tf"><?php echo $row_2['position_m']; ?></span>
                                            </div>
                                            <div class="profile-info-name" style="width:100px;"> ตัวอย่างลายมือชื่อ </div>
                                            <div class="profile-info-value " style="width:200px;vertical-align:middle;">
                                                <span id="sinature_img3_tf"><img src="http://eoffice.rd.go.th/e_office/signature/<?php echo $row_wt['withdraw_id3']; ?>.jpg" style="height:32px;"/></span>
                                            </div>
...
<script type="text/javascript">
	FusionCharts.ready(function() {
		var chartProperties = {
			"caption": "วงเงินเก็บรักษาแสตมป์อากรเทียบแสตมป์อากรคงคลัง",
			"showValues":"1",
			//"numberSuffix": "%",
			"xAxisName": "หน่วยงาน",
	...
	function SaveWithdrawTransaction(){
		...
		$.ajax({
			...
			+"&amount_withdraw_five_bath="+amount_withdraw_five_bath+"&amount_withdraw_twenty_bath="+amount_withdraw_twenty_bath+"&signature_id="+signature_id+"&withdraw_id1="+withdraw_id1+"&withdraw_id2="+withdraw_id2+"&withdraw_id3="+withdraw_id3+"&officeid="+officeid+"&withdraw_transaction_id="+withdraw_transaction_id,
			cache: false,
			success: function(data){
				if(data == "TRUE"){
					$.confirm({
