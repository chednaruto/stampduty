					...
					<div>
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        	...
                        	<?php
								...
								WHERE t.officeid = "'.$_SESSION['OFFICEID'].'" AND t.withdraw_document_status="Y"';
								...
								while($row_lm = mysql_fetch_array($rs_wb)){
									...
									echo '<td class="center">'.$row_lm['withdraw_document_number'].'</td>';
									...
									$rs2 = mysql_query('SELECT COUNT(*) as cc FROM tb_withdraw_board t WHERE t.withdraw_document_id="'.$row_lm['withdraw_document_id'].'"',$connection);
									...
									echo '<a class="green" href="index.php?service=withdrawboardEditing&withdraw_document_id='.$row_lm['withdraw_document_id'].'"><i class="ace-icon fa fa-pencil" style="margin-left:2px;margin-right:2px;"></i></a>';
									echo '<a class="green" target="_blank" href="WordTemplate/FWDWordExporter.php?withdraw_document_id='.$row_lm['withdraw_document_id'].'"><i class="ace-icon fa fa-file-word-o" style="margin-left:2px;margin-right:2px;"></i></a>';
									?>
									<a class="red" href="#" onclick="DeleteWithdraw('<?php echo $row_lm['withdraw_document_id'];?>')"><i class="ace-icon fa fa-trash" style="margin-left:2px;margin-right:2px;"></i></a>
                                    <?php
									echo '</div>';
									echo '</td>';
									echo '</tr>';
...
<script>
	function GoAdding(){
		window.location.href="index.php?service=withdrawboardAdding";
	}
