										...
										<div class="profile-info-value col-sm-10">
											<span>
                                            	<div class="input-group col-sm-12">
                                                    <input class="form-control active center" type="text" id="uid_tf" onkeydown="infomationHide();" value="<?php echo $_GET['id']; ?>">
		...
		$.ajax({
			...
			success: function(data){
				...
				if(result['DataUser']['Authen']==true){
						...
						$.ajax({
							type: "POST",
							url: "ajax/ajax_GetPermissionAdmin.php",
							data: "id="+uid,
							cache: false,
							success: function(ret){
								...
								$('#permission_status_tf').prop( "checked", permiss['permission_status']=='Y' );
							}
						});
						infomationShow();
					...
					$.confirm({
						...
						buttons: {
							somethingElse: {
								...
								keys: ['enter', 'shift'],
								action: function(){
									window.location.href="index.php?service=AdminuserManager"
								}
							}
						}
					});
