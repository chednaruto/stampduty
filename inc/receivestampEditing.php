				...
				<div class="col-xs-12">
					...
					<div>
						<div id="user-profile-1" class="user-profile row">
                            ...
                            <?php
								$sql1 = "SELECT * FROM tb_receive_transaction t WHERE t.receive_transaction_id = '".$_GET['receive_transaction_id']."'";
								...
								<div class="profile-user-info profile-user-info-striped">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
                                                    <input class="form-control center" type="text" id="stamp_one_bath_tf" placeholder="จำนวนดวง" value="<?php echo $row['stamp_one_bath']; ?>">
												</div>                                                
                                            </span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
                                                    <input class="form-control center" type="text" id="stamp_five_bath_tf" placeholder="จำนวนดวง" value="<?php echo $row['stamp_five_bath']; ?>">
												</div>                                                
                                            </span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
                                                    <input class="form-control center" type="text" id="stamp_twenty_bath_tf" placeholder="จำนวนดวง" value="<?php echo $row['stamp_twenty_bath']; ?>">
												</div>                                                
                                            </span>
										</div>
									</div>
                                    <div class="profile-info-row">
										...
										<div class="profile-info-value col-sm-12">
											<span>
                                            	<div class="input-group col-sm-6">
													<input class="form-control date-picker center" id="receive_date_tf" type="text" data-date-format="yyyy-mm-dd" value="<?php echo $row['receive_date']; ?>" disabled="disabled"/>
                                                    ...
                                                    <div class="input-group col-xs-12">
                                                        ...
                                                        <?php
															...
															while($row1 = mysql_fetch_array($rs1)){
																if($row['withdraw_id1']==$row1['id']){
																	echo '<option value="'.$row1['id'].'" selected="selected">'.$row1['fullname']." ตำแหน่ง ".$row1['position_m']." (".$row1['withdraw_board_type_name'].')</option>';
																}else{
                                                ...
                                                <span>
                                                    <div class="input-group col-xs-12">
                                                        ...
                                                        <?php
															...
															$rs1 = mysql_query($sql1,$connection);
															while($row1 = mysql_fetch_array($rs1)){
																if($row['receive_id1']==$row1['id']){
																	echo '<option value="'.$row1['id'].'" selected="selected">'.$row1['fullname']." ตำแหน่ง ".$row1['position_m']." (".$row1['stock_board_type_name'].')</option>';
																}else{
...
<script type="text/javascript">
	...
	function saveReceiveStamp(){
		...
		var receive_transaction_id = '<?php echo $_GET['receive_transaction_id']; ?>';
		...
		$.ajax({
			...
			data: "officeid="+officeid+"&receive_date="+receive_date+"&stamp_one_bath="+stamp_one_bath+"&stamp_five_bath="+stamp_five_bath+"&stamp_twenty_bath="+stamp_twenty_bath+"&withdraw_id1="+withdraw_id1+"&withdraw_id2="+withdraw_id2+"&withdraw_id3="+withdraw_id3+"&receive_id1="+stock_id1+"&receive_id2="+stock_id2+"&receive_id3="+stock_id3+"&receive_transaction_id="+receive_transaction_id,
			cache: false,
